export const wethConfig = {
  address: "0xCa5154456b54761a91a52Ea6D67dc277721040FA",
  abi: [
    {
      inputs: [],
...
export const usdcConfig = {
  address: "0xdC9e9475C5fBCe050205f77dd6DF3C8608FEcab4",
  abi: [
    {
      inputs: [],
      stateMutability: "nonpayable",
...
export const swapAppConfig = {
  ...
  abi: [
    ...
    },
    {
      inputs: [
        {
          ...
          internalType: "struct SwapApp.TradeParamsStruct",
          name: "tradeParams",
          type: "tuple",
        },
        {
      ...
      name: "UnsuccesfullTradeInititation",
      type: "error",
    },
    {
      anonymous: false,
