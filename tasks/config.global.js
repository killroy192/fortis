...
module.exports = {
  ...
  loggedNetworks: ["arbitrum-sepolia", "localhost"],
  verifyNetwork: ["arbitrum-sepolia"],
  localDeploymentFileName: "local.deployment-lock.json",
  deploymentFileName: "deployment-lock.json",
};
